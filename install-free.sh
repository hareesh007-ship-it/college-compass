...
echo "=== College Finder — Free / Local Tier Setup ==="
...
echo "       college-finder-free --student alex-sample run"
echo "  3. Add your own student:"
echo "       cp -r students/alex-sample students/<your-name>"
echo "       college-finder-free --student <your-name> run"
echo ""
...
echo "    college-finder-free --student <your-name> validate"
echo "    college-finder-free --student <your-name> run"
echo ""
